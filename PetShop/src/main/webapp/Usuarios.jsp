...
<fieldset>
	...
	<div  class="divformulario">
		...
		<input type="number" name="Cedula_usuario" value="<%=cedula%>" required <%=estado%>></div>
	<input type="hidden" name="Cedula_usuario" value="<%=cedula%>">
	<div class="divformulario">
		<label class="labelformulario">email_usuario: </label>
		<input   type="text" name="Email_usuario" value="<%=email_usuario%>" required>
	</div>
	<div class="divformulario" >
		<label class="labelformulario">nombre_usuario: </label>
		<input  type="text" name="Nombre_usuario" value="<%=nombre_usuario%>" required>
	</div>
	<div  class="divformulario">
		<label class="labelformulario">password: </label>
