...
public class Usuarios extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		if(request.getParameter("consultar")!=null) {
			...
			response.sendRedirect("Usuarios.jsp?Cedula_usuario="+Cedula_usuario+"&&Email_usuario="+Email_usuario+"&&Nombre_usuario="
			+Nombre_usuario+"&&Password="+Password+"&&Usuarios="+Usuario);
			}else
			{
		...
		if(request.getParameter("eliminar")!=null) {
			...
			if(usuarioDao.Eliminar_Usuario(Cedula_usuario)) {
				...
				System.out.println("usuario no se elimino");
